...
- [ ] Faire 5 tentatives de connexion rapides → Message "Trop de tentatives"
- [ ] Attendre 15 minutes → Nouvelles tentatives autorisées
...
- [ ] Page `/photos` charge correctement
- [ ] Tous les albums s'affichent avec leur image de couverture
- [ ] Cliquer sur un album → Redirection vers `/album/:id`
- [ ] Page détails album affiche toutes les photos en grille masonry
- [ ] Cliquer sur une photo → Ouverture en fullscreen
- [ ] Fermer fullscreen avec X ou clic en dehors

### 2.2 Création d'album (Admin)

- [ ] Se connecter en admin
- [ ] Sur `/photos`, cliquer "Ajouter un album"
- [ ] Remplir formulaire (titre + image de couverture)
- [ ] Valider → Album créé et visible immédiatement
- [ ] Vérifier sur Cloudinary que l'image est uploadée

### 2.3 Modification d'album (Admin)

- [ ] Cliquer "Modifier" sur un album
- [ ] Changer le titre → Sauvegarde et mise à jour
- [ ] Changer l'image de couverture → Nouvelle image visible

### 2.4 Suppression d'album (Admin)

- [ ] Cliquer "Supprimer" sur un album
- [ ] Confirmation → Album supprimé de la liste
- [ ] Vérifier que l'album n'existe plus dans la base MongoDB

### 2.5 Gestion des photos (Admin)

- [ ] Dans un album, cliquer "Ajouter des photos"
- [ ] Sélectionner 3 photos → Upload et affichage immédiat
- [ ] Cliquer "Supprimer" sur une photo → Photo retirée
- [ ] Vérifier lazy loading : scroll → Images chargent progressivement

### 2.6 Validation

- [ ] Tenter de créer un album sans titre → Message d'erreur
- [ ] Tenter de créer un album sans image → Message d'erreur
- [ ] Tenter d'uploader un fichier non-image → Rejet
...
- [ ] Page `/events` charge correctement
- [ ] Section "Prochain événement" affiche l'événement futur le plus proche
- [ ] Section "Tous les événements" affiche la liste complète
- [ ] Informations visibles : titre, dates, lieu, description, prix

### 3.2 Création d'événement (Admin)

- [ ] Se connecter en admin
- [ ] Cliquer "Créer un événement"
- [ ] Remplir formulaire complet (titre, dates, lieu, description, prix)
- [ ] Prix = 0 → Événement gratuit
- [ ] Prix > 0 → Événement payant
- [ ] Valider → Événement créé et visible

### 3.3 Modification d'événement (Admin)

- [ ] Cliquer "Modifier" sur un événement
- [ ] Changer le prix de 0€ à 20€ → Sauvegarde
- [ ] Changer les dates → Mise à jour correcte

### 3.4 Suppression d'événement (Admin)

- [ ] Cliquer "Supprimer" sur un événement
- [ ] Confirmation → Événement supprimé
- [ ] Vérifier disparition de la liste

### 3.5 Inscription gratuite

- [ ] Sur un événement gratuit (prix = 0€), cliquer "S'inscrire"
- [ ] Remplir formulaire : nom, email, téléphone, message
- [ ] Valider → Message de confirmation
- [ ] Vérifier réception de l'email à `Benezesriders164@gmail.com`
- [ ] Email contient : nom, email, téléphone, message du participant
